...
for data_dir in data_dirs:
    ...
    magnetization_in_T, ucvA = dtf.compute_magnetization(
    ...
    A_0, A_300, K_300, Js_300 = dtf.compute_exchange_and_anisotropy_constants(
        data_dir_MC, tot_moments_D, K1_in_JPerCubibm, ucvA, plot_Js=True
    )

    Ms_README_in_T, max_MAE_README_in_MJPerCubicm = dtf.extract_values_from_readme(
        data_dir
    )
    ...
    print(
        " MAE_in_MJPerCubicm = "
        + str(dtf.round_to_significant_digits(MAE_in_MJPerCubicm, 4))
        + " MJ/m^3"
    )
    ...
    print(
        ...
        + str(dtf.round_to_significant_digits(deviation_Ms_in_percent, 4))
        + " %"
    )
    ...
    try:
        ...
        print(
            ...
            + str(dtf.round_to_significant_digits(deviation_mae_percent, 4))
            + " %"
        )
    except NameError:
